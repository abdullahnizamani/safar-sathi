...
import { MapPin, Clock, Users, ArrowRight, User, GraduationCap, ArrowLeft, MessageSquare } from "lucide-react";
...
export default function RideDetail() {
  ...
  const handleRequestSeat = () => {
    createRequest.mutate({ data: { ride_id: rideId } }, {
      onSuccess: () => {
          ...
          <div className="bg-muted/30 p-8 border-b">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-6 text-2xl font-bold text-foreground">
              <div className="flex-1 min-w-0">
                ...
                <span className="truncate block">{ride.origin}</span>
              </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="truncate block">{ride.destination}</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-bold text-lg">{ride.driver_name}</div>
